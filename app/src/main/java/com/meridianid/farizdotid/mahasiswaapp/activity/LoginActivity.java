...
public class LoginActivity extends AppCompatActivity {
    ...
    @BindView(R.id.text_info_product)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spannable wordtoSpan = new SpannableString("Product of Mahapatih Sibernusa Teknologi");
        wordtoSpan.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.colorPrimary)), 0, 10, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        txtInfoProduct.setText(wordtoSpan);
        txtInfoProduct.setTypeface(Typeface.DEFAULT_BOLD);
